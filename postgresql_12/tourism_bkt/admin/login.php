  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
		      <form class="form-login" action="act/login.php" method="post">
		        <h2 class="form-login-heading" style="background:#ffd777">sign in now</h2>
		        <div class="login-wrap">       
		            ...
		            <hr>
                <a href="../" class="btn btn-theme btn-block"style="background:#ffd777;border-color:white">Back
		        </div>
		      </form>	  	
